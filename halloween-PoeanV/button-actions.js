...
function option1() {
  if (document.getElementById("option1").innerHTML == "Stand your ground" || "Fight") {
    ...
    inside = true;
  } else if (document.getElementById("option1").innerHTML == "Ignore it") {
    clear();
    document.getElementById("the-words3").innerHTML = "A big fish jumps out at you!";
...
function option2() {
  if (document.getElementById("option2").innerHTML == "Walk away" || "Oh heck no" || "RUN AWAY" || "Run") {
    flight();
  } else if (document.getElementById("option2").innerHTML == "Look") {
    document.getElementById("the-words3").innerHTML = "You see a big fish that jumps out at you!";
    document.getElementById("the-words3").innerHTML = "YOU DIED!";
  }
  else {
    run_away();
